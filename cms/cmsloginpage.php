...
<link href="style/style3.css" rel="stylesheet" type="text/css"/>
 ...
 <script type="text/javascript">
    ...
    {
    var a=document.forms["cmsloginpage"]["user"].value;
    var b=document.forms["cmsloginpage"]["pass"].value;
...
header('Refresh: 2; URL=cmsloginpage.php');
}
...
<form  action="cmsloginpage.php" method="post" name="cmsloginpage"  onsubmit="return validateForm()" id="cmsloginpage">
